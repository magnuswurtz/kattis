...
cli-itu/3.2.0 linux-x64 node-v14.17.6
$ itu --help [COMMAND]
USAGE
  $ itu COMMAND
...
...
_See code: [src/commands/canteen.ts](https://github.com/AsgereDreemurr/CLI-ITU/blob/v3.2.0/src/commands/canteen.ts)_
...
_See code: [src/commands/feedback.ts](https://github.com/AsgereDreemurr/CLI-ITU/blob/v3.2.0/src/commands/feedback.ts)_
...
_See code: [src/commands/kattis.ts](https://github.com/AsgereDreemurr/CLI-ITU/blob/v3.2.0/src/commands/kattis.ts)_
...
OPTIONS
  ...
  -d, --delete  remove a course from the config list
  -e, --edit    edit a course from the config list
  -h, --help    show CLI help
...
_See code: [src/commands/learnit.ts](https://github.com/AsgereDreemurr/CLI-ITU/blob/v3.2.0/src/commands/learnit.ts)_
...
_See code: [src/commands/open.ts](https://github.com/AsgereDreemurr/CLI-ITU/blob/v3.2.0/src/commands/open.ts)_
...
_See code: [src/commands/where.ts](https://github.com/AsgereDreemurr/CLI-ITU/blob/v3.2.0/src/commands/where.ts)_
<!-- commandsstop -->
